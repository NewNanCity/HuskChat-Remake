...
public class VelocityPlayerLocation implements PlayerLocationChangeEvent.PlayerLocation {
     ...
     */
    @NotNull
    public static VelocityPlayerLocation from(@NotNull String server, @NotNull String world) {
        return new VelocityPlayerLocation(server, world, 0, 0, 0, 0, 0);
    }
    ...
    public static VelocityPlayerLocation from(@NotNull String server, @NotNull String world,
                                            double x, double y, double z, float yaw, float pitch) {
        return new VelocityPlayerLocation(server, world, x, y, z, yaw, pitch);
    }
    ...
    public String toString() {
        return String.format("VelocityPlayerLocation{server='%s', world='%s', x=%.2f, y=%.2f, z=%.2f, yaw=%.2f, pitch=%.2f}",
